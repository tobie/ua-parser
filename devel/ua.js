...
var options = {
  ...
  testcasesfile: "test_user_agent_parser.yaml",  // output file for test cases
  listfile:      "ua.csv",            // output file os list
  logfile:       "ua.log",            // output logfile for broken test cases
